...
```{r, echo = FALSE}
    # PrimaryDirectory <- setwd('/Users/thomasa/OneDrive - The University of Sydney (Staff)/Library/Github (public)/Spectre/workflows/Spatial - simple/Spectre simple spatial/')
    PrimaryDirectory <- getwd()
```
