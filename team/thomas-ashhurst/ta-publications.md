...
My publications include [1 book](https://immunedynamics.io/thomas-ashhurst/publications/#books) and [23 published articles](https://immunedynamics.io/thomas-ashhurst/publications/#papers), with an [h-index of 9](https://scholar.google.com.au/citations?user=b1eTDlQAAAAJ&hl=en) (via Google Scholar). Online publication lists can be found on [PubMed](https://pubmed.ncbi.nlm.nih.gov/?term=thomas%20ashhurst&sort=date),
