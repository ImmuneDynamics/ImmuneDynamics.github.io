---
layout: ta
title: Thomas Ashhurst - Publication Stats
...
1. HM McGuire\*, **TM Ashhurst**\* (eds). 2019. [Mass Cytometry: Methods and Protocols](https://link.springer.com/book/10.1007/978-1-4939-9454-0). Springer New York.
...
2. AG Spiteri, RL Terry, CL Wishart, **TM Ashhurst**, IL Campbell, MJ Hofer, NJC King. 2021. [High-parameter Cytometry Unmasks Microglial Cell Spatio-temporal Response Kinetics in Severe Neuroinflammatory Disease](https://doi.org/10.21203/rs.3.rs-388801/v1). Research Square (pre-print).

3. GH Putri, I Koprinska, **TM Ashhurst**, NJC King, MN Read. 2021. [Using single-cell cytometry to illustrate integrated multi-perspective evaluation of clustering algorithms using Pareto fronts](https://doi.org/10.1093/bioinformatics/btab038). Bioinformatics. *Supervising role*.

4. GH Putri, MN Read, I Koprinska, **TM Ashhurst**, NJC King. 2019. [Dimensionality Reduction for Clustering and Cluster Tracking of Cytometry Data](https://link.springer.com/chapter/10.1007/978-3-030-30490-4_50). International Conference on Artificial Neural Networks, 624-640

5. GH Putri, MN Read, I Koprinska, D Singh, U Röhm, **TM Ashhurst**, NJC King. 2019. [ChronoClust: Density-based clustering and cluster tracking in high-dimensional time-series data](https://www.sciencedirect.com/science/article/pii/S0950705119300796). Knowledge-Based Systems 174, 9-26
