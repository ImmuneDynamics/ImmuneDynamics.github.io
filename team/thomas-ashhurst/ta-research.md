...
- Early PhD -- challenge of analysing HD data using conventional methods
- However, computational approaches at the time were not well suited to deal with large cytometry datasets.
- Developed CAPX, specifically to deal with large cytometry datasets
