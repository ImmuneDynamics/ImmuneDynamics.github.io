...
- AND faciliate integration and label transfer between datasets, so that reference datasets generated by the HCA and other groups could be leveraged in a wide variety of contexts, in both HD cytometry and single-cell SEQ
...
**More info**
For more information on Spectre, check out the '[about Spectre](https://wiki.centenary.org.au/x/az0MCQ)' page or [this talk](https://youtu.be/poEDERGXrQw?t=3151). If you are interested in testing new 'development' functions in Spectre, or adding your own function, see the [developers guide](https://wiki.centenary.org.au/x/lMj3C). 
