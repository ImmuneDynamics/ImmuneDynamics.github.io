...
![](Tutorial/Image%201.png){width="700"}
...
![](Tutorial/Image%202.png){width="400"}
...
![](images/clipboard-1161121180.png)
...
![](images/clipboard-3423209639.png)
...
-   If you wish, you can export the 'channel values' as a CSV file
    ...
    page](https://wiki.centenary.org.au/x/w8yACQ) for more information.*
...
The [Simple Discovery Workflow](https://wiki.centenary.org.au/x/4C8MCQ)
