...
Following the use of one of [Spectre's segmentation approaches](https://immunedynamics.io/spectre/spatial/), you can use an R script to convert TIFF files and masks into FCS files, for use in FlowJo. You can find the script here:
