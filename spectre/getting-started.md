...
Once you have completed the introductory tutorials, you can check out the analysis workflow options listed on the [Spectre home page](https://immunedynamics.io/spectre/). To get started, check out the 'simple discovery' workflow below.
