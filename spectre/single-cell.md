...
Though Spectre was not originally designed to work with genomic data, a number of Spectre's processing, analysis, or plotting functions can be helpful in analysing scRNAseq data. In [Spectre v2](https://immunedynamics.io/spectre/object![image](https://user-images.githubusercontent.com/11766139/164148341-67eb8b0b-f2e7-4592-82a6-ca67e89926e4.png)
) (not yet released), we have significantly expanded functionality for the analysis of data generated by any form of single-cell sequencing, cytometry, and imaging/spatial technologies. These updated workflows will be coming soon, but in the meantime, we have provided some helpful workflows below.
