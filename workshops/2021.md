...
- Tuesday (13-July): computational analysis of flow, spectral, or mass cytometry data using clustering (e.g. FlowSOM) and dimensionality reduction  (e.g. tSNE)
- Wednesday (14-July): managing batch effects and computational methods of batch alignment
- Thursday (15-July): performing meaningful differential, quantitative, and statistical analysis
...
<!-- FIRST ROW: TITLE --> 
    <tr style="border-top:1px solid grey">
      ...
      <td style="padding-left:.75em;padding-right:.75em;width:37.5%; border-left:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;text-align:left; vertical-align:top; background-color:#FAFAFA">
...
<!-- MONDAY --> 
    ...
    <!-- -->
      <td style="padding-left:.75em;padding-right:.75em;width:25%; border-left:1px solid #000;border-top:1px solid #FAFAFA;border-bottom:1px solid #000;border-right:1px solid #000;text-align:left; vertical-align:top">
        <b>Monday</b>: HD and SC technologies and analysis
