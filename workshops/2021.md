...
- Friday (16-July): advanced topics (image analysis, pseudotime, time-series, integrating data from multiple technologies, etc)
...
- Hands-on workshop (interactive attendance): $XX per person per workshop ($XX for students). Max 30 places for interactive attendance in each workshop. *Note: you can sign up for individual workshops (e.g. attend workshops on Monday and Wednesday only)*
