...
*Recordings of the lectures, as well as the material covered in the workshops will be made available online at the completion of the week*.
...
- Hands-on workshop (interactive attendance): $XX per person per workshop ($XX for students). Max 30 places for interactive attendance in each workshop.

*Note: you can sign up for individual workshops (e.g. attend workshops on Monday and Wednesday only)
