    ...
    <tr>
      ...
      <td style="padding-left:.75em;width:63%; border-left:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;text-align:left; vertical-align:top">
        <p> 
          ...
          <ul>
            <li>1000 - 1020: 
              <a href="">Welcome and overview of high-dimensional cytometry technologies and analysis</a>
            </li>
            <li>1020 - 1040: 
              <a href="">Clustering and visualiation</a>
            </li>
            <li>1040 - 1100: 
              <a href="">Quantitative, differential, and statistical analysis</a>
            </li>
          </ul>
          <b>Workshops</b>
          <ul>
            <li>1400 - 1600: 
              <a href="">(Stream A beginners): Getting started with R and RStudio (30 spots)</a>
            </li>
            <li>1400 - 1600: 
              <a href="">(Stream B advanced): End-to-end computational analysis workflow using Spectre in R (30 spots)</a>
            </li>
          </ul>
        </p>
      </td>
