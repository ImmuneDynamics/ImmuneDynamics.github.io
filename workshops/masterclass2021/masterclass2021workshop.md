  ...
  <tbody>
    <tr>
      ...
      <td style="padding-left:20px;padding-right:20px; width:20%; height:200; border-left:1px solid #FFFFFF;border-top:1px solid #FFFFFF;border-bottom:1px solid #FFFFFF;border-right:1px solid #FFFFFF;text-align:left; vertical-align:top">
          <img src="https://github.com/ImmuneDynamics/ImmuneDynamics.github.io/blob/master/workshops/FMW.jpeg?raw=true" width="300">
      </td>
      <td style="padding-left:25px;padding-right:25px; width:20%; height:200; border-left:1px solid #FFFFFF;border-top:1px solid #FFFFFF;border-bottom:1px solid #FFFFFF;border-right:1px solid #FFFFFF;text-align:left; vertical-align:top">
          <img src="https://github.com/ImmuneDynamics/ImmuneDynamics.github.io/blob/master/workshops/WZ.png?raw=true" width="300">
      </td>
       <td style="padding-left:.75em;padding-right:.75em;width:20%; height:200; border-left:1px solid #FFFFFF;border-top:1px solid #FFFFFF;border-bottom:1px solid #FFFFFF;border-right:1px solid #FFFFFF;text-align:left; vertical-align:top">
...
## Connecting to the virtual computers

---


Welcome to the ASI Masterclass workshop 2021! For the hand- on session, we have prepared a virtual machine that you can use to run the code we show during the session. Now to do this, there are few steps you need to first follow to get started. Follow all the steps in the “First setup procedure”, preferably before the very first hands on session. If you have problem please ask for help during the very first hands-on session. We’ll get someone to assist you!

After each session, please follow the steps in “Log off procedure” to turn these machines off.

To turn the machine back on and re-login, you only need to follow steps in “Re-login procedure”.

If at any steps you cannot proceed (the options are not available or that Microsoft said something went wrong please try again), try accessing the website (labs.azure.com) using either incognito mode in Chrome or private window in Firefox or something equivalent to this in other browsers.

### Initial setup

1. If you are on Mac, download Microsoft Remote Desktop app from app store. Link: https://apps.apple.com/au/app/microsoft-remote-desktop/id1295203466?mt=12

2. You should’ve received an email that look similar to the following in the inbox of the email address you use to register for the workshop. Now, click “Register for the lab” blue button. Check your junk/spam folder if it’s not in the inbox. If you can’t find it please email thomas.ashhurst@sydney.edu.au.

![image](https://user-images.githubusercontent.com/11766139/138665514-ac8e1cc2-08f0-4eab-92bd-88734a6d33b6.png)

3. Type in the email address you used to register for the homeshow and click next.

![image](https://user-images.githubusercontent.com/11766139/138665671-9440859d-5312-41f7-919d-8f18d6716e1d.png)

a. If you do not have a Microsoft account associated with the email address, you will be prompted to create one. Click “get a new Microsoft account”. Otherwise proceed to step 4.

![image](https://user-images.githubusercontent.com/11766139/138665767-2f19501c-6bcd-438f-8e0e-e63760e00daf.png)

b. Enter a password for your new Microsoft account and click “Next”. You don’t need to tick the box “I would like information...”.

![image](https://user-images.githubusercontent.com/11766139/138665840-e28ef5ae-fc2a-4a56-8445-9e6ba60f5932.png)

c. Microsoft will try to send a one off-code to your email. Paste the code in and click Next.

![image](https://user-images.githubusercontent.com/11766139/138665894-40b9992c-727d-4bee-ba7c-6069c780d774.png)

d. You will be logged in. Go to step 6.

4. Microsoft will try to send a one-off code to your email. Click send code. Check your inbox for the code

![image](https://user-images.githubusercontent.com/11766139/138665944-d58f6731-82e8-4236-914f-60bf4da88dbd.png)

5. Enter the code and click sign in

![image](https://user-images.githubusercontent.com/11766139/138665997-f3d85a6e-ce27-4d74-a45b-6dc635fd1b11.png)

6. Wait until the system finalise the registration process

![image](https://user-images.githubusercontent.com/11766139/138666025-79fa7773-b1cd-4101-b8d9-7cc7df146651.png)

Once done, you will see a page similar to the following: it will be called **ASI Masterclass 2021**. That is the computer that you will be using throughout the workshop.

![image](https://user-images.githubusercontent.com/11766139/138666065-fb586431-88e1-4345-aa34-794a2046c1fb.png)

7. The word “Stopped” indicate the computer is not turned on yet. Click on the slider to switch the computer on, and wait. The “Stopped” word should switch to “Starting...”.
Now go and brew a cup of tea while you wait for the machine to boot up. Once the computer is running, it the word “Starting...” should change to “Running”.

![image](https://user-images.githubusercontent.com/11766139/138666145-9e2c5213-7138-4dc7-a24a-5d388105a7aa.png)

8. Press on the tiny computer icon on the bottom right.

![image](https://user-images.githubusercontent.com/11766139/138666211-0b0cd92e-eceb-4cf4-bfd0-b9b6846110d6.png)

9. You will be prompted to set a password to login to your machine. Make one up, memorise it, and then enter it. Then click “Set password”.

![image](https://user-images.githubusercontent.com/11766139/138666238-be16a064-e687-4a11-84eb-3a463db48c23.png)

Microsoft will take some time to store your password. Go and grab a biscuit to dunk into your tea while it does it
